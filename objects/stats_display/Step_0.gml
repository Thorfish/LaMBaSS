...
with obj_card {
	if discarded {
		...
		if effect.my_type.object_index = type_extra {
			array_push(effects_, string(effect.my_type.extra_add.description,   round(effect.my_type.extra_add.description_val*effect.power_mod)))
		}
	}
}
